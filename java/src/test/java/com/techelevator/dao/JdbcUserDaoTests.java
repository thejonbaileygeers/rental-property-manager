...
public class JdbcUserDaoTests extends BaseDaoTests {
    protected static final User USER_1 = new User(1, "user1", "user1", "ROLE_USER", "555-555-5555", "Jon", "Geers", "tenant");
    protected static final User USER_2 = new User(2, "user2", "user2", "ROLE_USER", "555-555-5556", "Chris", "Jackson", "tenant");
    private static final User USER_3 = new User(3, "user3", "user3", "ROLE_USER", "555-555-5557", "Luis", "Manzo", "tenant");
    ...
    public void create_user_with_null_username() {
        sut.create(null, USER_3.getPassword(), "ROLE_USER", "5", "F", "D", "landlord");
    }

    @Test(expected = DataIntegrityViolationException.class)
    public void create_user_with_existing_username() {
        sut.create(USER_1.getUsername(), USER_3.getPassword(), "ROLE_USER", "5", "F", "D", "landlord");
    }

    @Test(expected = IllegalArgumentException.class)
    public void create_user_with_null_password() {
        sut.create(USER_3.getUsername(), null, "ROLE_USER", "5", "F", "D", "landlord");
    }

    @Test
    public void create_user_creates_a_user() {
        User newUser = new User(-1, "new", "user", "ROLE_USER", "5", "F", "D", "landlord");

        boolean userWasCreated = sut.create(newUser.getUsername(), newUser.getPassword(), "ROLE_USER", "5", "F", "D", "landlord");
